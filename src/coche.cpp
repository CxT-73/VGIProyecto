...
#include "objLoader.h" 
#include <iostream>
#include <Windows.h>      // Librería base de Windows
#include <mmsystem.h>     // Librería multimedia (sonido)
#pragma comment(lib, "winmm.lib") // Enlaza la librería automáticamente
